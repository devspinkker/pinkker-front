...
export default function AddEmblemPopup({ closePopup, emoteType, handleReload }) {
    ...
    async function handleSubmit() {
        try {
            ...
            const res = await axios.post(process.env.REACT_APP_DEV_API_URL + `/emblem/add_emblem_streamer?emoteName=${emoteName}&emoteType=${emoteType}`, formData, {
            ...
            <div style={{width: "100%", height: "100%", display: "flex", alignItems: "center"}}>
                ...
                <div className={'addemote-popup-container'}>
                    ...
                    <div className="addmote-popup-content">
                        <h3>Agregar un emblema a tu canal</h3>
