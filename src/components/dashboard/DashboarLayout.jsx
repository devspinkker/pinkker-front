        ...
        <Grid style={{ display: 'flex', flexDirection:'row' }}>
            ...
            >
                <div className="first-section">
                    <div className="navigation" style={{padding: '1rem 4rem !important', width:'90%'}}>
                    ...
                    {/* Contenido */}
                    <div className="content" style={{padding: '2.5rem 1rem' , display:'flex', flexDirection:'column', justifyContent:'flex-start'}}>
                        {children}
                    </div>
                </div>
            </Grid>
