        ...
        if(type === 0) {
            return (
                <div>
                        ...
                        <div className="usersettings-change-avatar">
                            ...
                            <div className="usersettings-card">
                                <div style={{width: "20%", textAlign: "center"}}>
                                    <img src={user.avatar} style={{borderRadius: "100px", width: "95px"}} alt="" />
                                </div>
                                <div style={{width: "55%"}}>
                                    <button onClick={() => togglePopupSettings()} className="button-settings-popup gray-button">Actualizar imagen de perfil</button>
                                    <p style={{fontSize: "13px", color: "darkgray", marginTop: "10px"}}>El formato debe ser JPEG, PNG o GIF y no puede superar los 10 MB.</p>
                                </div>
                            </div>
                        </div>
                    ...
                    {showPopupSettings === true && <UserSettingsPopup closePopup={() => togglePopupSettings()}/>}
                </div>
            )
        }
        ...
        <div className={"usersettings-body-" + theme.theme}>
            ...
            <div className="usersettings-navbar">
                ...
                <div style={{width: "100%", margin: "0 auto", borderTop: "0.01em solid #2b2b2b3f", marginTop: "20px", zIndex: "1000"}} className="type-set">
                        ...
                        <div style={{zIndex: "1000", width: "120px"}} onClick={() => setType(1)} className={ type === 1 ? "type-card active" : "type-card"}>
