...
export default function UserSettingsPopup({ closePopup }) {
    ...
    return (
        <div className='usersettings-popup-body'>
            <div style={{textAlign: "left", width: "25%"}} className={'usersettings-popup-container'}>
                ...
                <div style={{cursor: "pointer"}} className="usersettingspopup-card">
                    <div>
                      ...
                      <h4>Cargar foto</h4>
                      <input className="usersettings-loadfile" type="file" onChange={onFileChange} accept="image/*" />
                    </div> 
                </div>
            ...
            {showPopupCrop === true && <CropImage image={imageSrc} closePopup={() => togglePopupCrop()}/>}
