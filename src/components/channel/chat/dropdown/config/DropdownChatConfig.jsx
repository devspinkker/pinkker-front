...
function DropdownChatConfig({
    ...
    if (type === 0) {
      return (
        <div>
          ...
          >
            <p
              style={{ fontFamily: "Inter", fontWeight: "600", color: "#fff" }}
            >
              Apariencia de chat
            </p>
          ...
          <li
            ...
            //     ? `http://localhost:3000/${streamer}/popout/chat`
            //     : `https://pinkker.tv/${streamer}/popout/chat`,
            //   "Chat",
            //   500,
            //   900
            // )
        ...
        <div>
          ...
          >
            <p
              style={{ fontFamily: "Inter", fontWeight: "600", color: "#fff" }}
            >
              Marca de tiempo para nuevos mensajes
            </p>
            <Switch size="small" defaultChecked />
          </li>
        </div>
  ...
  return (
    <>
      <ul
        style={{
          marginTop: type === 1 && "-262px",
          height: type === 1 && "280px",
        }}
        className={
          click ? "dropdownchatconfig-menu clicked" : "dropdownchatconfig-menu"
        }
      >
