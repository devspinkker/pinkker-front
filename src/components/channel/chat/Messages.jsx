            ...
            <div className="chat-message-ban">
              <div style={{ textAlign: "center" }}>
                ...
                <p style={{ fontSize: "14px" }}>
                  No podrás participar en el chat de este canal hasta que un
                  moderador anule tu veto.Este canal permite a los usuarios
                  vetados solicitar una anulación tras una espera de 15 minutos.
                </p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="chat-message-ban">
              <div style={{ textAlign: "center" }}>
                ...
                <button
                  className="chat-button-view-chat"
                  onClick={() => viewChat()}
                >
                  Ver chat
                </button>
      ...
      <div>
          ...
          {messages.map((message, i) => (
            <div key={i}>
              <Message
                ...
                emotes={emotes}
                colorUser={message.color}
                handleClickUser={(streamer) => getUserInfo(streamer)}
                chatData={chatData}
                userMod={userMod}
                textSize={textSize}
                message={message}
        ...
        {isScrolled && (
          ...
          >
            ...
            {isHover === true && (
              <h3>
                <i style={{ marginRight: "5px" }} class="fas fa-arrow-down" />{" "}
                {messages.length - messagesInScrolled} mensajes nuevos
              </h3>
            )}
          </div>
        )}
