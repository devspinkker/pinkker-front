      ...
      if (bets.status === "OPEN") {
        return (
          <div
            ...
            style={{ height: expanded && "108px" }}
            className="bettop-container"
          >
            <div
              style={{
                display: "flex",
            ...
            >
              <div>
                ...
                >
                  Ahora puedes realizar apuestas
                </p>

                {title ? (
                  <h3 className="bettop-text-animation"> {bets.title} </h3>
                ) : (
                  <h3
                    className="bettop-text-animation"
              ...
              <div>
                <button onClick={() => handleBet()} className="bettop-button">
                  Apostar
                </button>
              </div>
            </div>
            ...
            {expanded && (
              <div
                style={{ width: "90%", margin: "0 auto", transition: "2s all" }}
              >
                <div
                  style={{
                    display: "flex",
