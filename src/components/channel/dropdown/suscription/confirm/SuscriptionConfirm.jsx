...
function SuscriptionConfirm( { socket, closeNavbar, title, streamer, streamerData } ) {
  ...
  async function handleSubmit() {
    if(user.coins < streamerData.suscriptionPrice) return alert({type: "ERROR", message: "No tienes los suficientes pixeles para suscribirte!"})
            ...
            <div style={{width: "90%", margin: "0 auto"}}>
                ...
                <div className='dropdownconfirm-total'>
                  ...
                  <div style={{display: "flex", alignItems: "center", marginTop: "20px"}}>
                    ...
                    <div>
                      <p style={{color: "white", fontWeight: "800"}}>Suscripción de nivel 1 a {streamer}</p>
                      <p style={{color: "lightgray", fontSize: "12px"}}>Cargo mensual periódico a partir del 5 oct 2022. Puedes cancelarlo cuando quieras en tu página de suscripciones.</p>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 style={{color: "white", display: "flex", alignItems: "center", justifyContent: "space-between", width: "95%", margin: "0 auto"}}>Total: <a style={{display: "flex", alignItems: "center"}}>{streamerData.suscriptionPrice} <img style={{width: "20px", marginLeft: "5px"}} src="/images/pixel.png"/></a></h3>
                  </div>
                </div>
                ...
                <div style={{display: "flex"}}>
                    <Tippy placement="bottom" theme="pinkker" content={<h1 style={{fontSize: "12px", fontFamily: "Montserrat"}}>Confirmar suscripción</h1>}>
                        <button onClick={() => handleSubmit()} className="dropdownconfirm-button-sub"> Confirmar</button>    
                    </Tippy>
                </div>
  ...
  return (
    <>
      <ul className={click ? 'dropdownconfirm-menu clicked' : 'dropdownconfirm-menu'}>
