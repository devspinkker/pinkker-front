    ...
    <div className="navbar-left-mobile">
      <div className="navbar-left-mobile-container">
        ...
        <div onClick={() => setActive(1)}  className="navbar-left-mobile-card">
          <Link style={{ textDecoration: "none", color: active === 1 ? "#ff60b2" : "white" }} to="/">
            <i style={{ position: "relative", fontSize: "28px" }} class="fa fa-home" />
            <h1 style={{ fontSize: "22px", fontFamily: "Cairo", position: "relative", top: "4px" }}>Home</h1>
          </Link>
        </div>
        <div onClick={() => setActive(2)}  className="navbar-left-mobile-card">
          <Link style={{ textDecoration: "none", color: active === 2 ? "#ff60b2" : "white" }} to="/plataform/explore">
            <i style={{ position: "relative", fontSize: "28px" }} class="fa fa-search" />
            <h1 style={{ fontSize: "22px", fontFamily: "Cairo", position: "relative", top: "4px" }}>Explorar</h1>
          </Link>
        </div>
        <div onClick={() => setActive(4)}  className="navbar-left-mobile-card">
          <Link style={{ textDecoration: "none", color: active === 4 ? "#ff60b2" : "white" }} to="/plataform/clips">
            <i style={{ position: "relative", fontSize: "28px" }} class="fas fa-film" />
            <h1 style={{ fontSize: "22px", fontFamily: "Cairo", position: "relative", top: "4px" }}>Clips</h1>
          </Link>
        </div>
        <div onClick={() => setActive(5)}  className="navbar-left-mobile-card">
          <Link style={{ textDecoration: "none", color: active === 5 ? "#ff60b2" : "white" }} to="/plataform/muro">
            <i style={{ position: "relative", fontSize: "28px" }} class="fas fa-edit" />
            <h1 style={{ fontSize: "22px", fontFamily: "Cairo", position: "relative", top: "4px" }}>Muro</h1>
          </Link>
