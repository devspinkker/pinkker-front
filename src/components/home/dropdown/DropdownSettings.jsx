...
function DropdownSettings( { closeNavbar, clip, big } ) {
      ...
      if(type === 0) {
        ...
        <div>
            ...
            <div style={{display: "flex", alignItems: "center", justifyContent: "space-between", width: "95%", margin: "8px auto", marginBottom: "6px"}}>                
                <li>
                    <h3 style={{color: "white", fontSize: "14px"}}><i style={{marginRight: "5px"}} class="fas fa-user-plus"/> Seguir</h3>
                </li>  
            </div>
  ...
  return (
    <>
      <ul ref={divRef} style={{left: clip === true && "0%", marginTop: big === true && "-205px"}} className={click ? 'dropdownsettingshome-menu clicked' : 'dropdownsettingshome-menu'}>

        <div style={{width: "99%"}} className="dropdownsettingshome-container">
