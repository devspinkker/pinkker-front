        ...
        return (
          ...
          >
            <Card
              ...
              spectators={categories[0].spectators}
            ...
            <Card
              ...
              spectators={categories[1].spectators}
              tags={categories[1].tags}
            />
            <Card
              isMobile={isMobile}
              isLoading={false}
              ...
              spectators={categories[2].spectators}
              tags={categories[2].tags}
            />
            <Card
              isMobile={isMobile}
              isLoading={false}
              ...
              spectators={categories[3].spectators}
              tags={categories[3].tags}
            />
            <Card
              isMobile={isMobile}
              isLoading={false}
              ...
              spectators={categories[4].spectators}
              tags={categories[4].tags}
            />
            <Card
              isMobile={isMobile}
              isLoading={false}
              ...
              spectators={categories[5].spectators}
              tags={categories[5].tags}
            />
          </ScrollingCarousel>
        );
      }
      ...
      {isLoading ? (
        ...
        <h3 style={{ color: "#ededed" }}>
          ...
          <Link
            ...
            className="text-remarcado"
            style={{ color: "#f36196", textDecoration: "none" }}
          >
            Categorias
          </Link>{" "}
