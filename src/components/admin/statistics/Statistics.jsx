...
export default function Statistics() {
    ...
    function onSuccess(position) {
        ...
        fetch(`https://api.opencagedata.com/geocode/v1/json?q=${latitude}+${longitude}&key=8ffa1a8586f34b94a21bb81c297cb5d3`)
            ...
            return (
                <div className="adminstatistics-card-container">
                    <div className="adminstatistics-card">
                        <div>
                            <h3>Usuarios</h3>
                            <h1 style={{color: "#ff60b2", marginTop: "10px"}}>{statistics.users}</h1>
                        </div>
                    </div>
                    <div className="adminstatistics-card">
                        <div>
                    ...
                    <div className="adminstatistics-card">
                        <div>
                            ...
                            <h1 style={{color: "#ff60b2", marginTop: "10px"}}>{statistics.streamings_online}</h1>
                        </div>
                    </div>
                    <div className="adminstatistics-card">
                        <div>
        ...
        <div className="adminstatistics-body">
            ...
            <div className="adminstatistics-container">
                ...
                <div style={{width: "50%", marginTop: "50px"}}>
                    <ReactWorldCountriesMap id="adminstatistics-map" color="#f36196" value-suffix="usuarios" size='responsive' tooltipBgColor='red' tooltipTextColor='white' data={data1} />
                </div>
