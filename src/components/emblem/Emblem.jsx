    ...
    return (
        <div style={style} className="emblem-img">
            <Tippy theme="pinkker" content={<h1 style={{fontSize: "12px", fontFamily: "Montserrat"}}>{name}</h1>}>
                <img onClick={() => setEmblemInfo(!emblemInfo)} style={{width: imageWidth ? imageWidth : "17px", borderRadius: "2px", position: "relative", top: "2px", cursor: "pointer", height:'17px !important'}} src={img} alt="" />
            </Tippy>
