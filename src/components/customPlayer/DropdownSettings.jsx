...
function DropdownSettings( { streamer, closeNavbar, quality, changeQuality } ) {
      ...
      if(type === 0) {
        ...
        <div>
            <li onClick={handleClick} >
                <Link style={{fontFamily: "Poppins", display: "flex", alignItems: "center", justifyContent: "center"}} className="dropdownsettings-link" to={"/" + user.name} onClick={closeNavbar}> 
                    Cerrar
            ...
            <li onClick={() => setType(1)}>
                <div className='dropdownsettings-content'>
                    ...
                    <div>
                        <h4 style={{color: "#ff60b2"}}>{quality} <i style={{color: "#ededed"}} class="fas fa-chevron-right"></i></h4>
                    </div>
                </div>
            </li>  
            ...
            <li onClick={() => popupwindow(`http://localhost:3000/${streamer}/popout/player`, "Player", 1280, 720)}>
                <div className='dropdownsettings-content'>
                    <div>
      ...
      if(type === 1) {
        ...
        <div>
            <li onClick={() => setType(0)}>
                <div className='dropdownsettings-content'>
                    <div>
                        <h4><i style={{marginRight: "5px"}} class="fas fa-chevron-left"></i> Calidad de video</h4>
                    </div>
                </div>
            </li> 
            ...
            <li onClick={() => changeQuality("auto")}>
                <div className='dropdownsettings-content'>
                    <div className='dropdownsettings-radio' style={{display: "flex", alignItems: "center"}}>
                        <input type="radio"/>
  ...
  return (
    <>
      <ul ref={divRef}  className={click ? 'dropdownsettings-menu clicked' : 'dropdownsettings-menu'}>
