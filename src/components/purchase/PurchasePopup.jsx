...
export default function PurchasePopup({amountt, closePopup}) {
    ...
    async function handleSubmit() {
        ...
        if(data != null && data != undefined) {
            const dataMp = await createMpOrder(token, amount, data.data.order)
            if(dataMp != null && dataMp != undefined) {
                window.location.href = dataMp.data
            }
        }
    }
    ...
    function getTotalPrice() {
        if(prices != null && prices != undefined) {
            if(amount == 100) {
                return prices.price100 * 1.21
            } else if(amount == 500) {
                return prices.price500 * 1.21
            } else if(amount == 1500) {
                return prices.price1500 * 1.21
            } else if(amount == 5000) {
                return prices.price5000 * 1.21
            } else if(amount == 10000) {
                return prices.price10000 * 1.21
            } else if(amount == 20000) {
                return prices.price20000 * 1.21
            }
        }
    }
            ...
            <div className='purchase-popup-container'>
                ...
                <div style={{padding: "30px"}}>
                    <div className="purchase-popup-close">
                        <button className="purchase-popup-button-close pinkker-button-more" onClick={closePopup}><i class="fas fa-times"/></button>
                    </div>
                    ...
                    <div className="purchase-popup-primary">
                        <div className="purchase-popup-primary-resume">
                            ...
                            <div className="purchase-popup-product">
                                ...
                                <div>
                                    <p style={{fontSize: "14px"}}>Paquete de {amount} pixeles</p>
                                    <p style={{color: "darkgray", fontSize: "14px"}}>Renovación de suscripción {getNewDateSuscription()}.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="purchase-popup-primary-quantity">
                            ...
                            <select className="purchase-popup-primary-quantity-select" defaultValue={1}>
                    ...
                    <div style={{textAlign: "left", display: "flex", alignItems: "center", justifyContent: "space-between"}}>
                        ...
                        <h3 style={{fontFamily: "Poppins", color: "white"}}>Total con IVA <a style={{marginLeft: "50px", fontFamily: "Poppins"}}>${getTotalPrice()} ARS</a></h3>
                    </div>    
                </div>
                ...
                <div className="purchase-popup-secondary">
                    <div style={{padding: "30px"}}>
                        ...
                        <div className="purchase-popup-secondary-buttons">
                            <button onClick={() => handleSubmit()} className="purchase-popup-secondary-button-mp"><img style={{width: "45px", marginRight: "10px"}} src="/images/mp.png"/> Mercado Pago</button>
