                            ...
                            <Grid container spacing={2}>
                              {search?.data?.map((game, index) => (
                                <Grid item xs={12} sm={6} md={4} key={index}>
                                  <Link key={index} to={`/${game?.NameUser}`} onClick={() => setHabilitar(false)}>
      ...
      loading ?
        ...
        <Grid>
          ...
          >
            ...
            <IconButton style={{ color: '#fff', position: 'fixed', bottom: '10%', right: '3%', backgroundColor: '#ff69c4', zIndex: 99999999 }} aria-label="fingerprint" color="secondary">
