...
export const getStreamerVod = async (streamer, limit, sort) => {
  try {
    let response = await axios.get(
      `${url}/vods_streamer?streamer=${streamer}&limit=${limit}&sort=${sort}`
    );
...
export const getStreamerClips = async (streamer, limit, sort) => {
  try {
    let response = await axios.get(
      `${url}/clips_streamer?streamer=${streamer}&limit=${limit}&sort=${sort}`
    );
    return response.data;
  } catch (error) {
...
export const getClipByIdWithToken = async (token, id) => {
  try {
    let response = await axios.get(
      `${url}/clip_by_id_with_token?clipId=${id}`,
      {
...
export const getClipsWithAuth = async (token, limit) => {
  try {
    let response = await axios.get(
      `${url}/get_clips_with_auth?limit=${limit}`,
      {
        headers: { Authorization: token },
      }
    );
