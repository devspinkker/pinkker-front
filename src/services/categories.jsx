...
export const getCategorieByName = async (categorie) => {
    try {
        let response = await axios.get(`${url}/get_categories_by_name/?name=${categorie}`);
        return response.data;
    } catch (error) {
        console.log('Error while calling participateBet', error);
    }
...
export const followCategorie = async (token, categorieFollow) => {
    try {
        const res = await axios.post(`${url}/follow_categorie`, {
            categorieFollow
        }, {
...
export const unfollowCategorie = async (token, categorieFollow) => {
    try {
        const res = await axios.post(`${url}/unfollow_categorie`, {
            categorieFollow
        }, {
            headers: {Authorization: token}
        })
...
export const userFollowCategorie = async (token, categorieFollow) => {
    try {
        const res = await axios.post(`${url}/user_follow_categorie`, {
            categorieFollow
        }, {
            headers: {Authorization: token}
        })
